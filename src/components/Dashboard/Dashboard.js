          ...
          <div className="p-6 ">
            ...
            <div className=' p-6 rounded-lg bg-jacarta-900'>
              <div className='flex md:gap-64'>
                ...
                className={`${
                  userPayment=="True" ? 'disabled bg-jacarta-400 cursor-not-allowed' : 'bg-accent hover:bg-accent-dark'
            ...
            <div className='bg-jacarta-900 p-6 rounded-lg my-14'>
              <div className='flex md:gap-64'>
                ...
                <div>
                    ...
                    <button className="disabled bg-jacarta-400 text-white font-bold py-2 px-4 rounded transition duration-300">
                      Application Closed
                    </button>
